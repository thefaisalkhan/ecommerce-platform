package com.faisal.ecommerce.inventory_service;
...
public class InventoryServiceDiscoveryController {

  private final DiscoveryClient discoveryClient;

  public InventoryServiceDiscoveryController(DiscoveryClient discoveryClient) {
