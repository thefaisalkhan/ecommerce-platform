package com.faisal.ecommerce.config_server;
...
public class ConfigServerDiscoveryController {

  private final DiscoveryClient discoveryClient;

  public ConfigServerDiscoveryController(DiscoveryClient discoveryClient) {
