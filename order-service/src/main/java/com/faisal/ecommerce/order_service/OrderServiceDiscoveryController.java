package com.faisal.ecommerce.order_service;
...
public class OrderServiceDiscoveryController {

  private final DiscoveryClient discoveryClient;

  public OrderServiceDiscoveryController(DiscoveryClient discoveryClient) {
