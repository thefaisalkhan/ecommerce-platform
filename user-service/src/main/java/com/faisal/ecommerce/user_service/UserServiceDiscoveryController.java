package com.faisal.ecommerce.user_service;
...
public class UserServiceDiscoveryController {

  private final DiscoveryClient discoveryClient;

  public UserServiceDiscoveryController(DiscoveryClient discoveryClient) {
