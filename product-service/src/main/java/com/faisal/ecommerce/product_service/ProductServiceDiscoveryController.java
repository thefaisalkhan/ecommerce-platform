package com.faisal.ecommerce.product_service;
...
public class ProductServiceDiscoveryController {

  private final DiscoveryClient discoveryClient;

  public ProductServiceDiscoveryController(DiscoveryClient discoveryClient) {
